...
def landing(code):
    ...
    lines += [
        ...
        "      words.forEach(function (word) { word.style.removeProperty('--cool-step'); });",
        ...
        "    //",
        "    // The last two words are left out on purpose: they arrive here already",
        "    // grey from the blink, and they contain no text of their own to fade.",
        "    function coolOrder() {",
        "      var pool = words.slice(0, Math.max(0, words.length - 2));",
