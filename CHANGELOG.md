...
- Night dimming no longer flickers when a player raises and drops its
  display-sleep assertion every few seconds: the screen dims only once
  another app's hold has been gone for a full thirty seconds, and the same
  settle applies after a video brought it back.
