...
L["en"] = {
    ...
    "modes_head": "Three modes, one click apart",
...
L["ru"] = {
    ...
    "modes_head": "Три режима, между ними один клик",
...
L["de"] = {
    ...
    "modes_head": "Drei Modi, einen Klick voneinander entfernt",
...
L["es"] = {
    ...
    "modes_head": "Tres modos, a un clic de distancia",
...
L["fr"] = {
    ...
    "modes_head": "Trois modes, à un clic l'un de l'autre",
...
L["it"] = {
    ...
    "modes_head": "Tre modi, a un clic di distanza",
