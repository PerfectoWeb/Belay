...
L["ru"] = {
    ...
    "modes_head": "Всё, что оно делает, в одной панели",
    ...
    "support_head": "Как помочь",
    "support_body": "Belay бесплатен и таким останется. Если он спас вам прогон, звезда на GitHub ничего не стоит и помогает другим его найти. Отчёты об ошибках и переводы ценнее денег.",
    "donate": "Поддержать",
