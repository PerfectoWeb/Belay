...
L["ru"] = {
    ...
    "h1": "Mac не заснёт, пока AI-агенты работают.",
    ...
    "support_head": "На кефирчик",
    "support_body": "Belay распространяется бесплатно и с открытым исходным кодом. Если он помог вам, оставьте звезду на GitHub и помогите другим найти его. Котику на корм? Архитектору крылья? Welcome!",
    "donate": "Поддержать",
