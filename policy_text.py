...
T["de"] = {
    ...
    "sharing_site": "Diese Website ist etwas anderes als die App, und sie zählt Besuche. Die Seiten unter <code>perfectoweb.github.io/Belay</code> laden Cloudflare Web Analytics, das die Seite, die Herkunft, das Land und den Browser erfasst. Es setzt keine Cookies, speichert nichts auf Ihrem Gerät und folgt Ihnen nirgendwohin. Auf dieser Datenschutzseite ist es nicht eingebunden.",
...
T["fr"] = {
    ...
    "sharing_site": "Ce site web est une chose distincte de l'app, et il compte les visites. Les pages sous <code>perfectoweb.github.io/Belay</code> chargent Cloudflare Web Analytics, qui enregistre la page, la provenance, le pays et le navigateur. Il ne pose aucun cookie, ne stocke rien sur votre machine et ne vous suit nulle part ailleurs. Cette page de politique est la seule où il n'est pas présent.",
...
T["zh"] = {
    ...
    "sharing_site": "本网站与应用是两回事，网站确实会统计访问。<code>perfectoweb.github.io/Belay</code> 下的页面会加载 Cloudflare Web Analytics，它记录页面、来源、国家和浏览器。它不设置 cookie，不在你的设备上存储任何内容，也不会跟踪你到别处。这份隐私政策页面是唯一没有它的页面。",
    "policy_head": "本政策的变更",
