...
struct BridgeScratch {
    ...
    init(settings: String? = nil) throws {
        root = FileManager.default.temporaryDirectory
            .appendingPathComponent("vigil-bridge-\(UUID().uuidString)", isDirectory: true)
        paths = BridgePaths(
            support: root.appendingPathComponent("Application Support/Vigil", isDirectory: true),
...
/// Vigil wants — including an HTTP hook on loopback at `/hook` that is *not*
