...
/// Every tunable the state machine reads. Owned by `VigilSettings` at runtime;
/// declared here so `VigilCore` stays free of the preferences layer.
///
...
/// Power conditions the coordinator has to respect. Supplied by `VigilPower`.
