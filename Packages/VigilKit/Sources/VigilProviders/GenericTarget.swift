...
/// A state report routed in from Vigil's loopback hook receiver.
///
/// The receiver itself belongs to `VigilHookBridge` and is deliberately neither
...
public struct GenericWebhookReport: Sendable, Equatable {
    ...
    /// The `state=` vocabulary lives in `VigilCore` so the receiver, this
