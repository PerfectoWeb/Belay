...
/// they are the only two places the channels differ — and VigilTipJar is the
/// module that owns that split. A dedicated `VigilUpdates` target is the
...
public enum Appcast {
    ...
    public static let feedURL = "https://updates.invalid.example/vigil/appcast.xml"
