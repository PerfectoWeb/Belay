...
/// Installs and removes Belay's hooks in `~/.claude/settings.json`.
///
...
public struct HookInstaller: Sendable {
    ...
    ///
    /// Deliberately does nothing when Belay is not installed: a stale record is
