    ...
    public static let all: [GenericConfigurationField] = [
        ...
        GenericConfigurationField(
            ...
            explanation: """
                ...
                Belay reads that files changed, never what is in them.
                """,
        ...
        GenericConfigurationField(
            ...
            title: "Webhook name",
            explanation: """
                The name a tool sends as session= when it calls Belay's local \
        ...
        GenericConfigurationField(
            ...
            explanation: """
                Quiet time before Belay decides the turn ended. Agents go silent \
