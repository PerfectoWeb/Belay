...
@Suite struct UpdateChannelTests {
    /// Until there is a signing key and a real feed (docs/BLOCKERS.md (git history) B3), the app
    ...
    /// key is the piece that is missing (docs/BLOCKERS.md (git history) B3). This used to insist
