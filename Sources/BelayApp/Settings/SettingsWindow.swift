...
final class SettingsWindow: NSObject {
    ...
    /// answer during login — exactly when Belay launches if "Open at login" is
    ...
    static let windowIdentifier = NSUserInterfaceItemIdentifier("belay.settings.window")
    ...
    private func makeToolbar() -> NSToolbar {
        let toolbar = NSToolbar(identifier: "belay.settings.toolbar")
