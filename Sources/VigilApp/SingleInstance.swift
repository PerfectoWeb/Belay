...
/// Makes sure only one Vigil is ever running.
///
...
enum SingleInstance {
    ...
    static func claim() -> Bool {
        // The XCTest host is itself a Vigil, so with a real one running the
        ...
        let identifier = Bundle.main.bundleIdentifier ?? "com.perfecto-web.vigil"
        ...
        Log.app.notice("another Vigil is already running; deferring to it")
