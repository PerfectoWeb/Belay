...
struct ProvidersSettingsPane: View {
    ...
    private var preciseDetectionRow: some View {
        SettingRow(
            ...
            explanation: """
                Lets Claude Code tell Vigil exactly when it starts and stops, \
                instead of Vigil inferring it from files. This is also what makes \
            ...
            if precise.isInstalled {
                ...
                .accessibilityHint("Removes Vigil's entries from your Claude Code settings")
            } else {
