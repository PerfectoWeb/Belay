...
/// The standard open panel that turns "Vigil would like to watch your agent"
...
enum ClaudeFolderPanel {
    static func run(startingAt folder: URL) -> URL? {
        ...
        panel.message = String(
            localized: "Let Vigil read your ~/.claude folder so it can tell when Claude Code is working."
        )
