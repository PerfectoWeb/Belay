...
/// The sounds and the one haptic Vigil makes.
///
/// Vigil is a utility that is meant to be forgotten about, so almost nothing it
...
/// "play user interface sound effects" preference, Vigil's own switch, and
...
enum Feedback {
    enum Sound: String, CaseIterable {
        /// Rising: Vigil decides for itself again.
        case auto = "mode-auto"
