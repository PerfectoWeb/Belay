...
/// The card is an advertisement Vigil sends out with no chance to explain
...
final class ShareCardTests: XCTestCase {
    ...
    func testCopyPutsBothTheCardAndTheWordsOnOnePasteboard() throws {
        let pasteboard = NSPasteboard(name: NSPasteboard.Name("com.perfecto-web.vigil.tests.card"))
